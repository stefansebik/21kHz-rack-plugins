...
struct TachyonEntangler : Module {
	...
	TachyonEntangler() {
        ...
        configParam(TachyonEntangler::A_OCTAVE_PARAM, 4, 12, 8);
        configParam(TachyonEntangler::A_COARSE_PARAM, -7, 7, 0);
        configParam(TachyonEntangler::A_FINE_PARAM, -0.083333, 0.083333, 0.0);
        configParam(TachyonEntangler::B_RATIO_PARAM, -1.0, 4.0, 0.0);
        
        configParam(TachyonEntangler::A_EXP_FM_PARAM, -1.7, 1.7, 0.0);
        configParam(TachyonEntangler::A_LIN_FM_PARAM, -11.7, 11.7, 0.0);
        configParam(TachyonEntangler::B_EXP_FM_PARAM, -1.7, 1.7, 0.0);
        configParam(TachyonEntangler::B_LIN_FM_PARAM, -11.7, 11.7, 0.0);
        
        configParam(TachyonEntangler::A_CHAOS_PARAM, 0.0, 1.0, 0.0);
        configParam(TachyonEntangler::A_SYNC_PROB_PARAM, 0.0, 1.0, 0.0);
        configParam(TachyonEntangler::B_CHAOS_PARAM, 0.0, 1.0, 0.0);
        configParam(TachyonEntangler::B_SYNC_PROB_PARAM, 0.0, 1.0, 1.0);
        
        configParam(TachyonEntangler::A_CHAOS_MOD_PARAM, -0.1, 0.1, 0.0);
        configParam(TachyonEntangler::A_SYNC_PROB_MOD_PARAM, -0.1, 0.1, 0.0);
        configParam(TachyonEntangler::B_CHAOS_MOD_PARAM, -0.1, 0.1, 0.0);
        configParam(TachyonEntangler::B_SYNC_PROB_MOD_PARAM, -0.1, 0.1, 0.0);
